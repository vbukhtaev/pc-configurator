...
class CpuPowerConnectorRestControllerIT extends AbstractIntegrationTest {
    ...
    void getAll_shouldReturnAllEntities() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        jsonPath("$", hasSize(2)),
                        jsonPath("$[0].name", is(connector4Pin.getName())),
    ...
    void getById_withExistentId_shouldReturnFoundEntity() throws Exception {
        // given
        final CpuPowerConnector saved = repository.save(
                mapper.convertFromDto(connector4Pin)
        );
    ...
    void create_withNonExistentName_shouldReturnCreatedEntity() throws Exception {
        ...
        assertThat(repository.findAll()).hasSize(1);
        final String jsonRequest = objectMapper.writeValueAsString(connector4Pin);
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        content().contentType(MediaType.APPLICATION_JSON),
                        jsonPath("$.name", is(connector4Pin.getName()))
                );
        ...
        assertThat(connector.getName()).isEqualTo(connector4Pin.getName());
    }
    ...
    void replace_withNonExistentName_shouldReturnReplacedEntity() throws Exception {
        ...
        final Optional<CpuPowerConnector> optConnector = repository.findById(saved.getId());
    ...
    void update_withExistentName_shouldReturnError() throws Exception {
        ...
        final UUID connector4PinId = repository.save(
                mapper.convertFromDto(connector4Pin)
        ).getId();
        final String jsonRequest = objectMapper.writeValueAsString(dto);
        final var requestBuilder = patch(
        ...
        final Optional<CpuPowerConnector> optConnector = repository.findById(connector4PinId);
        assertThat(optConnector).isPresent();
        assertThat(optConnector.get().getName())
